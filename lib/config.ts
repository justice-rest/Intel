...
export const NON_AUTH_ALLOWED_MODELS = ["openrouter:perplexity/sonar-reasoning-pro"]

export const FREE_MODELS_IDS = ["openrouter:perplexity/sonar-reasoning-pro"]

export const MODEL_DEFAULT = "openrouter:perplexity/sonar-reasoning-pro"
