...
2. Executing multiple searches across authoritative sources
3. Cross-referencing and validating information
4. Synthesizing a comprehensive answer with citations
...
This is a beta feature available to Scale plan users only.`,
  parameters: z.object({
    ...
    outputType: z
      ...
      .describe(
        "Output format - 'sourcedAnswer' for narrative with citations (default), 'searchResults' for raw results"
      ),
  }),
